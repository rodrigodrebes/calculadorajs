...
const previousOperandTextElement = document.querySelector('[data-operacao-previa]')
const currentOperandTextElement = document.querySelector('[data-operacao-corrente]')
